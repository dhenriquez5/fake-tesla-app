  ...
  return (
    <main>
      <header className="py-3 px-10 flex items-center fixed top-0 w-full justify-between z-40 text-white" >
        ...
        <nav>
          <ul className='flex text-sm [&>li>a]:text-white [&>li>a]:font-medium [&>li>a]:inline-block [&>li>a]:py-2 [&>li>a]:px-4'>
      ...
      <section className=" h-screen w-screen text-center relative overflow-hidden">
        <div className="z-30 relative h-full flex flex-col">
          <header>
            ...
            <p className="text-white text-sm">Progame una prubea de conduccion  hoy mismo</p>

          </header>
          <footer className="flex flex-col flex-grow flex-nowrap justify-end pb-20" >
            <div>
              <a className='text-white text-sm border-[3px] border-white bg-white/5 backdrop-blur-sm rounded font-medium px-12 py-2 inline-block hover:bg-white hover:text-black transition-colors' href="#">
        ...
        <div className="absolute top-0 bottom-0 h-full z-10 w-full">
          <video className="object-center object-cover h-full w-full" autoPlay muted loop src="/homevideo.webm"></video>
        </div>
